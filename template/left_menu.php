<div id='menu'>
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                <div><a href="alliance.php">{Alliance}</a></div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <div><a href="fleet.php">{Fleet}</a></div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                <div><a href="galaxy.php?mode=0">{Galaxy}</a></div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                <div><a href="techtree.php">{Technology}</a></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <div><a href="stat.php?range={user_rank}">{Statistics}</a></div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                <div><a href="#" onClick="f('buddy.php', '');" accesskey="c">{Buddylist}</a></div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
