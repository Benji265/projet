...
class Planets extends Database
{
    ...
    /**
     * Methode qui permet de recuperer les ressource depenser si on annule la construction d'une central electrique solaire
     *
     * @param integer $metalUser
     * @param integer $metalPrice
     * @param integer $cristalUser
     ...
     * @return void
     */
    public function updateRessourceAfterCancelCentral(int $metalUser, int $metalPrice, int $cristalUser, int $cristalPrice, int $deuteriumUser, int $deuteriumPrice, int $energyUser, int $ernergyCost, int $id): void
    {
        $bdd = $this->connectDatabase();
    ...
    /**
     * Methode qui permet d'update le nom de la planete a partir de l'id de l'utilisateur
     *
     * @param string $name
     * @param integer $id
     * @return void
